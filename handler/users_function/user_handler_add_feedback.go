...
// UsersFeedback godoc
// @Summary UsersFeedback
// @Description UsersFeedback
// @Tags usersFeedback
// @Accept  json
// @Produce  json
...
// @Router /v1/api/users/feedback{user_id} [post]
func UsersFeedback() func(*gin.Context) {
	return func(c *gin.Context) {
		...
		err := uc.AddFeedbackUsersFeedback(c.Request.Context(), user_id, data)
		if err != nil {
