...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/v1/api/admin/menu_add": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "CustomizationOption",
        ...
        "/v1/api/users/feedback_history{user_id}": {
            "post": {
        ...
        "/v1/api/users/order_history/{user_id}": {
            "get": {
        ...
        "/v1/api/users/order_status/{user_id}/status": {
            "patch": {
